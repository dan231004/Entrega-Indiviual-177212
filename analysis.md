...
![Comparación de casos](images/comparison_time.png)
...
### Uso de la Herramienta "rqt_plot"

También se utilizó `rqt_plot` para monitorear en tiempo real los tópicos `/turtle1/cmd_vel/linear/x`, `/turtle1/cmd_vel/angular/z`, `/turtle1/pose/x`, `/turtle1/pose/y` y `/turtle1/pose/theta`. Esta herramienta permitió verificar que el controlador enviaba comandos de velocidad durante la trayectoria y que, al llegar a la meta, las velocidades se estabilizaban en cero.

Para el Caso A
![Uso de rqt_plot](images/casoA.png)

Para el Caso B
![Uso de rqt_plot](images/casoB.png)

Para el Caso C
![Uso de rqt_plot](images/casoC.png)
