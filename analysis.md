...
|---|---:|---:|---:|---:|---:|---:|---|
| A | 1.0 | 2.0 | ____ s | ____ | ____ | ____ | Movimiento más suave, pero posiblemente más lento. |
| B | 1.5 | 4.0 | ____ s | ____ | ____ | ____ | Configuración intermedia, buen balance entre rapidez y estabilidad. |
| C | 2.0 | 6.0 | ____ s | ____ | ____ | ____ | Movimiento más rápido, pero con mayor posibilidad de oscilaciones. |
...
Error inicial: ____
Error final: ____
Tiempo de llegada: ____ s
Distancia recorrida: ____
Error máximo: ____
Error promedio: ____
Oscilaciones detectadas: ____
Velocidad máxima: ____
```
...
De acuerdo con los resultados experimentales, la mejor combinación fue el caso ____ porque presentó un buen equilibrio entre tiempo de llegada, error final, distancia recorrida y número de oscilaciones.
